...
const Orders = () => {
  ...
  useEffect(() => {
    fetch(`https://parkmate-backend.onrender.com/api/slots/booked`)
      .then((res) => res.json())
      .then((data) => {
  ...
  useEffect(() => {
    if (userId) {
      fetch(`https://parkmate-backend.onrender.com/api/bookings/latest/${userId}`)
        .then((res) => res.json())
        .then((data) => {
  ...
  useEffect(() => {
    if (userId) {
      fetch(`https://parkmate-backend.onrender.com/api/bookings/history/${userId}`)
        .then((res) => res.json())
        .then((data) => {
  ...
  const handleSlotSelect = async (slot) => {
    if (!isSlotSelected && !bookedSlots.includes(slot)) {
      ...
      try {
        const response = await fetch(`https://parkmate-backend.onrender.com/api/slot-bookings/assign-slot`, {
          method: "POST",
